...
return [
    ...
    'fields'                            => [
        ...
        'image'                             => 'Sidebar image (appears in campaign navigation)',
        'is_discreet'                       => 'Unlisted',
    ...
    'helpers'                           => [
        ...
        'character_personality_visibility'  => 'Default visibility for character personality traits when creating new characters.',
        ...
        'entity_privacy'                    => 'Default visibility when you create entities like characters, locations, or events.',
        ...
        'related_visibility'                => 'Default visibility for posts, connections, abilities, attributes, and other content added to entities.',
    ...
    'roles'                             => [
        ...
        'helper'        => [
            ...
            '2'                     => 'Entities can have more fine-tuned permissions by viewing the "Permissions" tab of an entity. This tab appears once the campaign has several roles or members.',
    ...
    'sharing'                           => [
        ...
        'language'  => 'Language of the campaign\'s content.',
    ...
    'ui'                                => [
        ...
        'fields'            => [
            ...
            'entity_history'    => 'Entity history logs',
        ...
        'helpers'           => [
            ...
            'entity-history'    => 'Control who can see view edit history for campaign entities.',
            'member-list'       => 'Control who can view the campaign\'s member list.',
            'other'             => 'Set default display options for entity pages.',
