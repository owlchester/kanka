...
return [
    ...
    'features'              => [
        ...
        'boosts'            => [
            ...
            'entity-aliases'        => 'Set aliases on entities for more flexible search and mentions',
            'entity_files_v2'       => 'Max uploaded files per entity',
            'entity_links'          => 'Set links on entities to external resources and websites',
            'header_image'          => 'Entity header background image',
            ...
            'timeline_elements'     => 'Customise the icon and colour of timeline elements',
    ...
    'goodbye'               => [
        ...
        'description_4' => 'Thank you again for being a part of our community. We wish you all the best in your future worldbuilding endeavours.',
        'title'         => 'Goodbye',
    ],
    'help'                  => [
