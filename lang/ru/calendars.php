...
return [
    ...
    'event'         => [
        ...
        'helpers'   => [
            'add'               => 'Добавьте существующий объект в этот календарь.',
            'new'               => 'Или создайте новое напоминание, просто дав ему название.',
            'other_calendar'    => 'Вы редактируете напоминание календаря :calendar.',
        ],
        'modal'     => [
            'title' => 'Добавление напоминания в календарь',
        ],
    ...
    'hints'         => [
        ...
        'intercalary'       => 'Дни, которые не входят в обычные месяцы и дни недели. Они влияют циклы лун, но не на дни недели.',
