...
return [
    ...
    'alerts'                    => [
        ...
        'copy_invite'       => 'Ligazón de convite á campaña copiada ao portapapeis.',
    ...
    'bulk'                      => [
        ...
        'success'       => [
            ...
            'public'            => '{1} :count entidade é agora visible|[2,*] :count entidades son agora visibles.',
    ...
    'edit'                      => 'Editar',
    'errors'                    => [
        'boosted'                       => 'Esta función só está dispoñible para campañas potenciadas.',
        'boosted_campaigns'             => 'Esta función só está dispoñible para :boosted.',
        ...
        'unavailable_feature'           => 'Función non dispoñible',
    ],
    'events'                    => [],
    'export'                    => 'Exportar',
    'fields'                    => [
        ...
        'has_entity_files'      => 'Ten ficheiros de entidade',
        'has_image'             => 'Contén unha imaxe',
        'has_posts'             => 'Contén entradas',
    ...
    'files'                     => [
        'actions'   => [
            'drop'      => 'Fai clic para engadir un ficheiro, ou arrástrao ata aquí.',
            'manage'    => 'Xestionar ficheiros de entidade',
        ],
        'errors'    => [
            'max'       => 'Chegaches ao número máximo (:max) de ficheiros para esta entidade.',
            'no_files'  => 'Non hai ficheiros.',
        ],
        'files'     => 'Ficheiros subidos.',
        'hints'     => [
            'limit'         => 'Cada entidade pode ter ata :max ficheiros subidos.',
            'limitations'   => 'Formatos soportados: :formats. Tamaño máximo do ficheiro: :size',
        ],
        'title'     => 'Ficheiros da entidade ":name"',
    ],
    'filter'                    => 'Filtrar',
    'filters'                   => [
    ...
    'helpers'                   => [
        ...
        'learn_more'    => 'Aprende máis desta funcionalidade na nosa :documentation.',
    ...
    'hints'                     => [
        ...
        'image_limitations'     => 'Formatos soportados: :formats. Tamaño máximo do ficheiro: :size.',
    ...
    'is_private'                => 'Esta entidade é privada e só é visible para a administración da campaña.',
    'keyboard-shortcut'         => 'Atallo de teclado :code',
    'legacy'                    => 'En desuso',
    'move'                      => [],
    'navigation'                => [
        'cancel'            => 'cancelar',
    ...
    'placeholders'              => [
        ...
        'creature'      => 'Escolle unha criatura',
        'entity'        => 'Entidade',
        'entry'         => 'Usa "@" seguido de tres letras para mencionar outra entidades da campaña.',
