...
return [
    ...
    'call-to-action'    => 'Définis des vignettes personnalisée pour tous les personnages, lieux ou autres entités de la campagne. Ces images sont ensuite affichées sur les différentes listes.',
    'create'            => [
        'error'     => 'Problème lors de la sauvegarde. Est-ce que :type est déjà créé?',
        'helper'    => 'Ajouter une image qui sera utilisée comme vignette par défaut pour les entités du type sélectionné.',
