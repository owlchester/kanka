...
return [
    ...
    'description'       => 'Importer les entrées, les articles, les propriétés, la galerie et d\'autres éléments d\'une exportation de campagne dans cette campagne. Cela se produit dans le backend et peut prendre un certain temps, alors profites d\'un café. Tu et les autres administrateurs de campagne serez informés lorsque le processus d\'importation sera terminé.',
