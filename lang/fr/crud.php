...
return [
    ...
    'fields'            => [
        ...
        'stealth_edit'              => 'Mise à jour silencieuse',
        'stealth_edit_helper'       => 'Si cochée, la sauvegarde ne mettra pas à jour la date de dernière modification de l’entrée.',
        'stealth_edit_post_helper'  => 'Si cochée, la sauvegarde de cet article ne mettra pas à jour sa date de dernière modification.',
        'template'                  => 'Modèle',
        'tooltip'                   => 'Infobulle',
        'type'                      => 'Type',
