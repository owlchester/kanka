...
return [
    ...
    'header-image'      => [
        ...
        'description'           => 'Afficher une image d\'arrière plan dans l\'entête de l\'entité. Pour le meilleur résultat, utiliser une image très large.',
        'title'                 => 'Image d\'entête',
    ],
    'tooltip'           => [
        'boosted-description'   => 'Remplacer le texte d\'infobulle de l\'entité automatiquement généré avec une :boosted-campaign.',
        'description'           => 'Remplacer le texte d\'infobulle de l\'entité automatiquement généré par le texte suivant.',
