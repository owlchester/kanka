...
return [
    'actions'       => [
        'add_epoch'         => 'Add uma época',
        'add_intercalary'   => 'Add dias intercalares',
        'add_month'         => 'Add um mês',
        'add_moon'          => 'Add uma lua',
        'add_reminder'      => 'Add um lembrete',
        'add_season'        => 'Add uma estação',
        'add_weather'       => 'Definir efeitos do clima',
        'add_week'          => 'Add uma semana nomeada',
        'add_weekday'       => 'Add um dia da semana',
        'add_year'          => 'Add um ano nomeado',
    ...
    'event'         => [
        ...
        'create'    => [
            ...
            'title'     => 'Add um Evento de Calendário para :name',
        ],
        ...
        'helpers'   => [
            'add'               => 'Add um evento existente para esse calendário.',
        ...
        'modal'     => [
            'title' => 'Add um evento ao calendário',
        ],
    ...
    'events'        => [
        ...
        'start'     => '(começo)',
        'title'     => 'Eventos do Calendário :name',
    ],
    'fields'        => [
        'calendar'              => 'Calendário Primário',
