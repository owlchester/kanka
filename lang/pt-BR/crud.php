...
return [
    ...
    'bulk'              => [
        'actions'       => [
            'edit'          => 'Editar & tagging',
            'kits'          => 'Aplicar kit de propriedades',
            'modify'        => 'Modificar',
        ...
        'modify'        => [
            'title' => 'Modificar múltiplos elementos',
        ],
        'permissions'   => [
            'fields'    => [
                'override'  => 'Sobrepor',
    ...
    'fields'            => [
        ...
        'excerpt'                   => 'Resumo',
        'has_attributes'            => 'Possui propriedades',
        'has_entity_files'          => 'Possui mídia',
        'has_entry'                 => 'Possui descrição',
        'has_image'                 => 'Possui uma imagem',
        'has_posts'                 => 'Possui artigos',
        ...
        'stealth_edit'              => 'Atualizar silenciosamente',
        'stealth_edit_helper'       => 'Marque para salvar sem atualizar a data da última modificação da entidade.',
        'stealth_edit_post_helper'  => 'Marque esta opção para salvar o artigo sem atualizar a data da última modificação do registro.',
        'template'                  => 'Modelo',
    ...
    'filters'           => [
        ...
        'lists'             => [
            ...
            'paginated' => 'Alterne entre filhos diretos e todos os níveis de descendentes. Os resultados são paginados para garantir o desempenho.',
        ],
        'mobile'            => [
            'clear' => 'Limpar',
    ...
    'hints'             => [
        ...
        'image_formats'         => 'Formatos suportados: :formats.',
        ...
        'kit'                   => 'O conjunto de propriedades selecionado será aplicado ao salvar a entidade.',
