...
return [
    'actions'       => [
        'apply_kit'     => 'Aplicar um kit de propriedades',
        'load'          => 'Carregar',
        'manage'        => 'Gerenciar',
        'more'          => 'Outros',
        ...
        'show_hidden'   => 'Mostrar propriedades ocultas',
        'toggle_privacy'=> 'Privado/Público',
    ],
    'errors'        => [
        'api'                   => 'Data inválida',
        'loop'                  => 'Existe um loop infinito no cálculo dessa propriedade!',
        'no_attribute_selected' => 'Selecione um ou mais propriedades primeiro.',
    ...
    'fields'        => [
        ...
        'is_private'            => 'Propriedades Privadas',
        'is_star'               => 'Fixado',
        'kit'                   => 'Kit',
