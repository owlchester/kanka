...
return [
    ...
    'helpers'       => [
        'default_layout'    => '选择默认查看日历所用的视图。',
        'month_type'        => '闰月不使用工作日，但仍然影响月亮和季节。',
        'moon_offset'       => '一般而言，第一次满月会出现在第0年的第一天。修改偏移量会改变第一次满月发生的时间。这个值可以既可以是负值也可以是正值(最高为一个月的长度)。',
        'nested_without'    => '显示所有没有父日历的日历。点击某一行以查看子日历。',
        'start_offset'      => '日历默认从第0年的第一个工作日开始。修改该项会影响日历第一日的位置。',
    ],
    'hints'         => [
        'event_length'      => '活动持续的时间。一个活动周期不能超过2个月。',
        'intercalary'       => '在标准的月与周之外的日子。他们不会影响工作日，但会影响月相。',
        'is_incrementing'   => '进阶日历会在UTC 0时自动更新当前日期。',
        'is_recurring'      => '活动可以设置为"重复"状态。这会让它在每年的同一日发生。',
        'months'            => '你的日历至少需要有两个月。',
    ],
];
