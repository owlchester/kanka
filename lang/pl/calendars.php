...
return [
    ...
    'options'       => [
        'events'    => [
            'recurring_periodicity' => [
                ...
                'first_quarter_name'    => 'Pierwsza kwadra księżyca :moon',
                'fullmoon'              => 'Pełnia',
                'fullmoon_name'         => 'Pełnia księżyca :moon',
                'last_quarter'          => 'Ostatnia kwadra',
                'last_quarter_name'     => 'Ostatnia kwadra księżyca :moon',
                'month'                 => 'Co miesiąc',
                'newmoon'               => 'Nów',
                ...
                'waning_crescent_name'  => 'Ubywający sierp ksieżyca :moon',
                'waning_gibbous'        => 'Ubywający garb',
                'waning_gibbous_name'   => 'Ubywający garb księżyca :moon',
                'waxing_crescent'       => 'Przybywający sierp',
                'waxing_crescent_name'  => 'Przybywający sierp ksieżyca :moon',
                'waxing_gibbous'        => 'Przybywający garb',
                'waxing_gibbous_name'   => 'Przybywający garb księżyca :moon',
                'year'                  => 'Co rok',
            ],
        ],
        'resets'    => [
    ...
    'show'          => [
        ...
        'moon_age'              => ':phase (:count dzień temu)|:phase (:count dni temu)',
        'moon_first_quarter'    => ':moon - pierwsza kwadra',
        'moon_full'             => ':moon - pełnia',
        'moon_last_quarter'     => ':moon - ostatnia kwadra',
        'moon_new'              => ':moon - nów',
        'moon_waning_crescent'  => ':moon - ubywający sierp',
        'moon_waning_gibbous'   => ':moon - ubywający garb',
        'moon_waxing_crescent'  => ':moon - przybywający sierp',
        'moon_waxing_gibbous'   => ':moon - przybywający garb',
        'tabs'                  => [
            'events'    => 'Epizody',
            'weather'   => 'Pogoda',
        ],
