...
return [
    ...
    'help'      => [
        ...
        'helper'        => 'Jeśli masz pytania albo opinie, :contact-us albo zajrzyj do naszych :docs. Tam właśnie dzieje się światotwórcza magia.',
    ...
    'premium'   => [
        'action'    => 'Odblokuj',
        'helper'    => 'Odblokuj funkcje premium, w tym własne kategorie, dostęp do :plugins i nie tylko.',
        'title'     => 'Używaj funkcji premium kampanii',
    ],
    'roadmap'   => [
        'action'    => 'Zobacz mapę drogową i sugerowane funkcje',
        'helper'    => 'Kankę tworzymy z myślą o was. Sprawdź publiczny plan rozwoju i głosuj na funkcje, które chcesz wprowadzić.',
