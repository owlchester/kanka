...
<th class="align-middle">
    ...
    @else
        <a class="btn btn-block btn-sm btn-warning " data-toggle="ajax-modal" data-target="#subscribe-confirm" data-url="{{ route('settings.subscription.change', ['tier' => \App\Models\Pledge::KOBOLD]) }}">
...
<th class="align-middle">
    ...
    @else
        ...
        @else
            <a class="btn btn-block btn-sm btn-success price-monthly" data-toggle="ajax-modal" data-target="#subscribe-confirm" data-url="{{ route('settings.subscription.change', ['tier' => \App\Models\Pledge::OWLBEAR, 'period' => 'monthly']) }}">
        ...
        @else
            <a class="btn btn-block btn-sm btn-success price-yearly" data-toggle="ajax-modal" data-target="#subscribe-confirm" data-url="{{ route('settings.subscription.change', ['tier' => \App\Models\Pledge::OWLBEAR, 'period' => 'yearly']) }}">
...
<th class="align-middle">
    ...
    @else
        <a class="btn btn-block btn-sm btn-success price-monthly" data-toggle="ajax-modal" data-target="#subscribe-confirm" data-url="{{ route('settings.subscription.change', ['tier' => \App\Models\Pledge::WYVERN, 'period' => 'monthly']) }}">
    ...
    @else
        <a class="btn btn-block btn-sm btn-success price-yearly" data-toggle="ajax-modal" data-target="#subscribe-confirm" data-url="{{ route('settings.subscription.change', ['tier' => \App\Models\Pledge::WYVERN, 'period' => 'yearly']) }}">
...
<th class="align-middle">
    ...
    @else
        <a class="btn btn-block btn-sm btn-success price-monthly" data-toggle="ajax-modal" data-target="#subscribe-confirm" data-url="{{ route('settings.subscription.change', ['tier' => \App\Models\Pledge::ELEMENTAL, 'period' => 'monthly']) }}">
    ...
    @else
        <a class="btn btn-block btn-sm btn-success price-yearly" data-toggle="ajax-modal" data-target="#subscribe-confirm" data-url="{{ route('settings.subscription.change', ['tier' => \App\Models\Pledge::ELEMENTAL, 'period' => 'yearly']) }}">
