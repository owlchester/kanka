...
<footer id="footer" class="main-footer">
    ...
    <div class="footer-links">
        ...
        <div class="footer-copyright text-center">
            Kanka v{{ config('app.version') }} ({{ gethostname() }}) - {!! __('front.footer.copyright', ['copy' => '&copy;', 'year' => date('Y'), 'company' => 'Owlchester SNC'])!!} - {{ __('footer.server_time', ['time' => \Carbon\Carbon::now()->isoFormat('MMMM Do YYYY, h:mm a')]) }}
        </div>
    </div>
</footer>
