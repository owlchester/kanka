...
@endif
<div class="dropdown">
    <a role="button" class="cursor-pointer w-8 h-8 rounded-full hover:bg-base-200 flex items-center justify-center align-middle" data-dropdown aria-expanded="false" data-placement="right" data-tree="escape" aria-haspopup="menu" aria-controls="actions-submenu" aria-label="{{ __('crud.actions.actions') }}">
