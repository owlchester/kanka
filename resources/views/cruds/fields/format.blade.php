<div class="field-format">
    <label>
        ...
        <i class="fa-solid fa-question-circle hidden-xs hidden-sm" aria-hidden="true" data-toggle="tooltip" title="{{ __('calendars.helpers.format', ['format' => __('calendars.helpers.custom_format')]) }}" href="https://docs.kanka.io/en/latest/entities/calendars.html#date-format"></i>
    </label>
