            ...
            <div class="row margin-bottom">
                ...
                <div class="col-sm-2 text-center">
                    ...
                    @if ($permissionService->inherited(\App\Models\CampaignPermission::ACTION_READ, 0, $member->user_id))
                        <i class="text-{{ $permissionService->inheritedRoleAccess(\App\Models\CampaignPermission::ACTION_READ, $member->user_id) ? 'green' : 'red' }} fa fa-check-circle" title="{{ __('crud.permissions.inherited_by', [
                ...
                <div class="col-sm-2 text-center">
                    ...
                    @if ($permissionService->inherited(\App\Models\CampaignPermission::ACTION_EDIT, 0, $member->user_id))
                        <i class="text-{{ $permissionService->inheritedRoleAccess(\App\Models\CampaignPermission::ACTION_EDIT, $member->user_id) ? 'green' : 'red' }} fa fa-check-circle" title="{{ __('crud.permissions.inherited_by', [
                ...
                <div class="col-sm-2 text-center">
                    ...
                    @if ($permissionService->inherited(\App\Models\CampaignPermission::ACTION_DELETE, 0, $member->user_id))
                        <i class="text-{{ $permissionService->inheritedRoleAccess(\App\Models\CampaignPermission::ACTION_DELETE, $member->user_id) ? 'green' : 'red' }} fa fa-check-circle" title="{{ __('crud.permissions.inherited_by', [
                ...
                <div class="col-sm-2 text-center">
                    ...
                    @if ($permissionService->inherited(\App\Models\CampaignPermission::ACTION_POSTS, 0, $member->user_id))
                        <i class="text-{{ $permissionService->inheritedRoleAccess(\App\Models\CampaignPermission::ACTION_POSTS, $member->user_id) ? 'green' : 'red' }} fa fa-check-circle" title="{{ __('crud.permissions.inherited_by', [
