                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            @if (is_array($field))
                                ...
                                @endif
                            @else
                                <label>{{ __((in_array($field, ['name', 'type', 'is_private', 'has_image', 'has_attributes', 'has_entity_files', 'has_entity_notes', 'date_range']) ? 'crud.fields.' : $langKey . '.fields.') . $field) }}</label>
