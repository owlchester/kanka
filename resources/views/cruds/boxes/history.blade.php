...
<div class="entity-modification-history">
    ...
    @if ($model->entity)
      ...
      @can('update', $model)
          <br /><a href="{{ route('entities.logs', $model->entity) }}" data-toggle="ajax-modal" data-target="#large-modal" data-url="{{ route('entities.logs', $model->entity) }}" title="{{ __('crud.history.view') }}">
