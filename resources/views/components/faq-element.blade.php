...
>
    <button class="cursor-pointer flex justify-between items-center w-full gap-2 px-6 py-4 text-left focus:outline-none" data-animate="collapse" data-target="#{{ $id }}">
