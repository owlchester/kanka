...
@if ($quickCreator)
    <div class="input-group-btn">
        <a class="quick-creator-subform btn btn-tab-form" data-url="{{ route('entity-creator.form', ['campaign' => $campaign, 'type' => 'locations', 'origin' => 'entity-form', 'target' => $fieldUniqIdentifier, 'multi' => true]) }}">
