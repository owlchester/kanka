...
<x-forms.field
    ...
    <select multiple="multiple" name="races[]" class=" select2 join-item" data-tags="true" style="width: 100%" data-url="{{ route('races.find', $campaign) }}" data-allow-clear="true" data-allow-new="false" data-placeholder="" id="{{ $fieldUniqIdentifier }}">
