...
<select multiple="multiple" name="races[]" id="races" class="form-control select2" data-tags="true" style="width: 100%" data-url="{{ route('races.find') }}" data-allow-clear="true" data-allow-new="false" data-placeholder=" ">
