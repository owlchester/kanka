...
<select multiple="multiple" name="races[]" class="form-control select2 join-item" data-tags="true" style="width: 100%" data-url="{{ route('races.find') }}" data-allow-clear="true" data-allow-new="false" data-placeholder="" id="{{ $fieldUniqIdentifier }}">
...
@if ($quickCreator)
        <a class="quick-creator-subform btn2 join-item btn-primary btn-outline" data-url="{{ route('entity-creator.form', ['type' => 'races', 'origin' => 'entity-form', 'target' => $fieldUniqIdentifier, 'multi' => true]) }}">
