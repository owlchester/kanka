    ...
    <section class="features" id="privacy">
        <div class="container">
            <div class="section-heading">
                ...
                <p class="mt-2">Kanka collects the email addresses of those who communicate with us via email, and information submitted through voluntary activities such as site registrations or participation in surveys. Kanka also collects aggregated, anonymous user data regarding app usage. The user data we collect is used to improve Kanka and the quality of our service. We only collect personal data required to provide our services, and we only store it insofar that it is necessary to deliver these services.</p>
                <p><br /></p>
                <h3>Your data</h3>
                ...
                <h3>Changes</h3>
                <p>If our information practices change at some time in the future we will post the policy changes to our website to notify you of these changes and we will use for these new purposes only data collected from the time of the policy change. If you are concerned about how your information is used, you can check our website regularly.</p>
                <p><br /></p>
            </div>
        </div>
    </section>
