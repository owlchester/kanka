@extends('layouts.front', [
    'title' => __('footer.premium'),
])

@section('og')
    <meta property="og:description" content="{{ __('front/premium.description', ['kanka' => config('app.name')]) }}" />
    <meta property="og:url" content="{{ route('front.premium') }}" />
@endsection
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 my-5 landing-heading">
                    <h1 class="display-4 mt-5">{{ __('footer.premium') }}</h1>
                </div>
    ...
    <section class="py-50" id="boosted">
        <div class="container">
            <div class="section-heading text-center">
                ...
                <h2>{{ __('front/premium.unlock.title', ['kanka' => config('app.name')]) }}</h2>
                <p class="my-2">
                    {!! __('front/premium.unlock.description', ['kanka' => config('app.name')]) !!}
                </p>
...
'marketplace' => link_to('https://marketplace.kanka.io', 'Marketplace', ['target' => '_blank'])
                        ...
                        <img src="{{ Img::crop(120)->new()->url('app/features/boosted/look-n-feel.jpg') }}"
                    ...
                    <div class="text-center booster-card">
                        ...
                        <img src="{{ Img::crop(120)->new()->url('app/features/boosted/entity.jpg') }}"
                    ...
                    <div class="text-center booster-card">
                        ...
                        <img src="{{ Img::crop(120)->new()->url('app/features/boosted/default.jpg') }}"
    ...
    'rpgawesome' => link_to('https://nagoshiashumari.github.io/Rpg-Awesome/', 'RPGAwesome', ['target' => '_blank'])
                        ...
                        <img src="{{ Img::crop(120)->new()->url('app/features/boosted/icon.jpg') }}"
                    ...
                    <div class="text-center booster-card">
                        ...
                        <img src="{{ Img::crop(120)->new()->url('app/features/boosted/boosted-relations.jpg') }}"
                    ...
                    <div class="text-center booster-card">
                        ...
                        <img src="{{ Img::crop(120)->new()->url('app/features/boosted/gallery.jpg') }}"
                    ...
                    <div class="text-center booster-card">
                        ...
                        <img src="{{ Img::crop(120)->new()->url('app/features/boosted/achievements.jpg') }}"
    ...
    <section class="py-50">
        <div class="container text-center">
            ...
            <p class="my-3">
                {{ __('front/boosters.call-to-action.description_v2') }}
            </p>
