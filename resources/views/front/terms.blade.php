    ...
    <section class="features" id="terms">
        <div class="container">
            <div class="section-heading">
                ...
                <h2 class="mt-4" id="user-representations"><a href="#user-representations">USER REPRESENTATIONS</a></h2>
                ...
                <h2 class="mt-4" id="user-registration"><a href="#user-registration">USER REGISTRATION</a></h2>
                ...
                <h2 class="mt-4" id="prohibited-activities"><a href="#prohibited-activities">PROHIBITED ACTIVITIES</a></h2>
                ...
                <h2 class="mt-4" id="site-management"><a href="#site-management">SITE MANAGEMENT</a></h2>
                ...
                <h2 class="mt-4" id="copyright-infringements"><a href="#copyright-infringements">COPYRIGHT INFRINGEMENTS</a></h2>
                ...
                <h2 class="mt-4" id="term-and-termination"><a href="#term-and-termination">TERM AND TERMINATION</a></h2>
                ...
                <h2 class="mt-4" id="user-data"><a href="#user-data">USER DATA</a></h2>
                ...
                <h2 class="mt-4" id="miscellaneous"><a href="#miscellaneous">MISCELLANEOUS</a></h2>
