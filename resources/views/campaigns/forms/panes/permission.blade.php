...
<div class="tab-pane" id="form-permission">
    ...
    <x-grid type="1/1" class="max-w-xl">
        <x-helper>
            <p>{{ __('campaigns.helpers.privacy') }}</p>
        </x-helper>

        <h4>{{ __('campaigns/privacy.titles.entity') }}</h4>
        ...
        <hr />
        <h4>{{ __('campaigns/privacy.titles.media') }}</h4>
        ...
        <hr />
        <h4>{{ __('campaigns/privacy.titles.mention') }}</h4>
