<div class="tab-pane" id="form-dashboard">
    ...
    <div class="form-group">
        <label>
            ...
            <i class="fa fa-question-circle hidden-xs hidden-sm" title="{{ __('campaigns.helpers.excerpt') }}" data-toggle="tooltip" data-placement="bottom"></i>
        </label>
    ...
    <div class="form-group">
        ...
        <div class="row">
            <div class="col-md-10">
                ...
                <p class="help-block">
                    {{ __('crud.hints.image_limitations', ['format' => 'PNG, JPG, GIF, WebP', 'size' => auth()->user()->maxUploadSize(true)]) }}
