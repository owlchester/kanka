...
'edit' => '<span class="badge border select-none flex items-center gap-2"><i class="fa-regular fa-pencil" aria-hidden="true"></i> ' . __('campaigns.show.actions.edit') . '</span>',
    ...
    'posts' => '<a target="_blank" href="https://docs.kanka.io/en/latest/features/articles.html" class="text-link">' . __('entities.posts') . ' <i class="fa-regular fa-external-link" aria-hidden="true"></i></a>']) !!}
        </li>
        <li class="">
