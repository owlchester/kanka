...
<div
    class="campaign-header cover-background p-4 relative z-[10] @if(!empty($campaign->header_image))campaign-imaged-header px-4 md:px-10 py-6 md:py-14 pt-12 md:pt-24 @else no-header @endif "
