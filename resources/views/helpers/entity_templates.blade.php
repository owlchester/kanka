...
@section('content')
    ...
    'link' => '<code><i class="fa fa-star" aria-hidden="true"></i> ' .  __('entities/actions.templates.set') . '</code>',
...
'new' => '<button class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> ' . __('crud.new_entity.title') . '</button>',
    ...
    'remove' => '<code><i class="fa fa-star-o" aria-hidden="true"></i> ' .  __('entities/actions.templates.unset') . '</code>',
    'link' => '<code><i class="fa fa-star" aria-hidden="true"></i> ' .  __('entities/actions.templates.set') . '</code>',
]) !!}
            </p>
        </div>
