@if (!isset($model) || auth()->user()->can('map', $model))
    ...
    <p class="alert alert-warning">{!! __('locations.helpers.map_deprecated_2', ['boosted' => link_to_route('front.features', __('crud.boosted_campaigns'), '#boost')]) !!}</p>
    ...
    <div class="row">
        <div class="col-md-10">
            ...
            <p class="help-block">
                {{ __('crud.hints.image_limitations', ['formats' => 'jpg, png, gif, webp, svg', 'size' => auth()->user()->maxUploadSize(true, 'map')]) }}
