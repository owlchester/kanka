                                        ...
                                        <li>
                                            <a href="{{ route('entities.template', $entity) }}">
                                                @if($entity->is_template)
                                                    <i class="fa-solid fa-star-o" aria-hidden="true"></i> {{ __('entities/actions.templates.unset') }}
                                                @else
                        ...
                        @endif
                                    ...
                                    <li>
                                        <a href="{{ route('entities.json-export', $entity) }}">
                                            <i class="fa-solid fa-download" aria-hidden="true"></i> {{ trans('crud.actions.json-export') }}
                                        </a>
                                    </li>
                                @endif
