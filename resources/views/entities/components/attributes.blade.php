...
@if (count($attributes) > 0)
    @foreach ($attributes as $attribute)
        <li class="list-group-item pinned-attribute @if ($attribute->isSection()) pinned-attribute-section text-center @endif" data-attribute="{{ $attribute->name }}" data-target="{{ $attribute->id }}">
