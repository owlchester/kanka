...
<li class="list-group-item">
        ...
        @can('update', $model)
            <i class="fa-solid fa-cloud-upload-alt pull-right entity-file-ui" data-url="{{ route('entities.entity_files.index', $model->entity) }}" data-toggle="ajax-modal" data-target="#entity-modal" title="{{ __('crud.files.actions.manage') }}"></i>
        @endif
        </b>
