    ...
    <div class="entity-asset asset-alias flex justify-center items-center overflow-hidden mb-4" data-id="{{ $asset->id }}" data-asset-type="alias">
        ...
        <div class="w-1/2 text truncate p-2">
            ...
            @if(auth()->check() && auth()->user()->can('update', $entity->child))
                <a href="{{ route('entities.entity_assets.edit', [$campaign, $entity, $asset]) }}" data-toggle="ajax-modal" data-target="#entity-modal" data-url="{{ route('entities.entity_assets.edit', [$campaign, $entity, $asset]) }}">
