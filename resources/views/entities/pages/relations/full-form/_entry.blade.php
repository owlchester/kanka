    ...
    @if(empty($relation) && (!isset($mirror) || $mirror == true))
        <div class="field-two-way">
            <label class="" data-toggle="collapse" data-target="#two-way-relation">
                ...
                <i class="fa-solid fa-question-circle hidden-xs hidden-sm" data-title="{{ __('entities/relations.hints.two_way') }}" data-toggle="tooltip"></i>
            </label>
        ...
        <div class="field-target-relation">
            <div class="collapse !visible" id="two-way-relation">
                <label>
                    ...
                    <i class="fa-solid fa-question-circle hidden-xs hidden-sm" data-title="{{ __('entities/relations.hints.target_relation') }}" data-toggle="tooltip"></i>
                </label>
