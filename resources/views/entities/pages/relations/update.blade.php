...
@section('content')
    {!! Form::model($relation, ['route' => ['entities.relations.update', ['campaign' => $campaign, 'entity' => $entity->id, $relation]], 'method' => 'PATCH', 'data-shortcut' => 1]) !!}
    ...
    {!! Form::open([
        'method' => 'DELETE',
        'route' => ['entities.relations.destroy', [$campaign, $entity, $relation, 'mode' => request()->mode, 'option' => request()->option]],
