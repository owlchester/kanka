...
@section('content')
    ...
    {!! Form::open(['method' => 'DELETE', 'route' => ['entities.entity_assets.destroy', 'entity' => $entity, 'entity_asset' => $entityAsset], 'style' => 'display:inline', 'id' => 'delete-file-' . $entityAsset->id]) !!}
    {!! Form::close() !!}
@endsection
