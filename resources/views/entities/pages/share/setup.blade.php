@php
    $shareTranslations = [
        ...
        'option_entity_public'   => __('entities/share.options.make_entity_public'),
        'option_global_public'   => __('entities/share.options.make_all_public'),
...
<div id="entity-share-container" class="p-1">
    <entity-share-modal
