<div class="join">
    <a href="{{ isset($entityType) ? $entityType->createRoute($campaign) : route($plural . '.create', [$campaign]) }}" class="btn2 btn-primary join-item btn-new-entity" data-entity-type="{{ $name }}"
