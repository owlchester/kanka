...
@section('content')
    ...
    <p>You can now enjoy Kanka with bigger upload sizes, participate in <a href="{{ \App\Facades\Domain::toFront('votes') }}">community votes</a>, and <a href="{{ route('settings.premium') }}">premium campaigns</a>.</p>

    <p style="text-align: center">
        <a href="{{ route('settings.premium', ['utm_source' => 'newsletter', 'utm_medium' => 'email', 'utm_campaign' => 'elemental']) }}" class="mail-btn">Unlock premium features</a>
    </p>
