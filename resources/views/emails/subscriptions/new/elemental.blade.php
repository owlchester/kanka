...
@section('content')
    ...
    <p>You can now enjoy Kanka with bigger upload sizes, participate in <a href="{{ route('community-votes.index') }}">community votes</a>, and <a href="{{ route('settings.premium') }}">premium campaigns</a>.</p>
