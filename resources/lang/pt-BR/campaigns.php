...
,
    ...
    'fields'                            => [
        ...
        'character_personality_visibility'  => 'Visibilidade de personalidade do personagem como padrão',
    ...
    'roles'                             => [
        ...
        'users'         => [
            'actions'   => [
                ...
                'remove_user'   => 'Remover usuário da função',
            ],
            'create'    => [
                'success'   => 'Usuário adicionado a função :role',
