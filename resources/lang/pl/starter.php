...
return [
    ...
    'character1'    => [
        ...
        'name'      => 'Jakub Sowoser (przykład)',
        'race'      => 'Człowiek',
        'sex'       => 'Mężczyzna',
        'title'     => 'Szary Łowca',
        'traits'    => 'Zawsze nagina prawdę na swoją korzyść.',
    ],
    'character2'    => [
        'fears'     => 'Wywołać tak wielki wybuch, jak to możliwe',
        'history'   => 'To przykładowa postać. Irwonę od dziecka fascynowały materiały wybuchowe i teraz produkuje je zawodowo.',
        'name'      => 'Irwona Klejnocik (przykład)',
        'race'      => 'Gnomka',
        'sex'       => 'Kobieta',
