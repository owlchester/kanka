...
return [
    'campaign'          => [
        ...
        'export_error'  => 'При экспорте изображений вашей кампании произошла ошибка. Пожалуйста, свяжитесь с нами, если проблема повторится. Это может случатся с большими кампаниями,где много изображений.',
    ...
    'clear'             => [
        'action'    => 'Очистить все',
        'confirm'   => 'Вы уверены, что хотите удалить все уведомления? Это действие необратимо.',
