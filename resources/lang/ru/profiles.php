...
return [
    ...
    'newsletter'    => [
        'helpers'   => [
            'community-vote'    => 'Будьте в курсе, когда откроется новое :community-vote.',
            ...
            'release'           => 'Будьте в курсе, когда выйдет новая версия Kanka и что в ней нового.',
        ],
        'links'     => [
    ...
    'placeholders'  => [
        ...
        'password'                  => 'Укажите ваш текущий пароль, чтобы продолжить.',
    ],
    'sections'      => [
        'delete'    => [
    ...
    'settings'      => [
        ...
        'helpers'   => [
            'editor_v2' => 'В старом редактору (TinyMCE) не работают упоминания на мобильных устройствах и не поддерживаются некоторые функции, например галерея кампании.',
        ],
        'hints'     => [
            'advanced_mentions'     => 'Если включено, то все упоминания при редактировании объекта будут иметь такой формат: [entity:123].',
            'default_nested'        => 'Если включено, то все списки, которые можно свернуть, будут свернуты по умолчанию.',
            'new_entity_workflow'   => 'При создании объекта, по умолчанию открывается страница со списком объектов того же типа. Чтобы открывался созданный объект, выберите "К созданному объекту".',
        ],
