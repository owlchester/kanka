...
return [
    ...
    'helpers'       => [
        'date'          => 'В это поле можно написать что угодно. Оно не связано с календарями кампании. Чтобы связать событие с календарем, добавьте его в календарь на его странице или во вкладке напоминаний этого события.',
