...
return [
    ...
    'section_9_v2'      => 'Мы сделали все основные функции Kanka бесплатными, и мы всегда будем следовать этому пути. Однако, если вы хотите поддержать нас в этом проекте, вы можете стать подписчиком и получить доступ к дополнительным функциям, а также нашу вечную благодарность. Узнайте больше :pricing.',
