...
return [
    ...
    'helpers'       => [
        ...
        'nested'        => 'Изначально отображаются только организации без родительских организаций. Нажмите на организацию, чтобы посмотреть список ее подорганизаций.',
    ],
    'index'         => [
    ...
    'members'       => [
        ...
        'create'        => [
            'description'   => 'Добавление члена в организацию.',
    ...
    'placeholders'  => [
        ...
        'type'      => 'Культ, банда, сопротивление, фэндом',
    ],
    'quests'        => [
