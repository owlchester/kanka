...
return [
    ...
    'event'         => [
        ...
        'helpers'   => [
            ...
            'new'               => 'Или создайте новое событие, просто задав его название.',
    ...
    'events'        => [
        'description'   => 'События этого календаря',
    ...
    'helpers'       => [
        ...
        'nested'        => 'Изначально отображаются только календари без родительских календарей. Нажмите на календарь, чтобы посмотреть список его потомков.',
        'start_offset'  => 'По умолчанию календарь начинается с первого дня недели 0 года. Изменение этого поля влияет на положение первого дня календаря.',
    ],
    'hints'         => [
        'intercalary'       => 'Дни, которые выпадают из обычных месяцев и дней недели. Они влияют на луны, но не на дни недели.',
        'is_incrementing'   => 'Каждый день в 00:00 по UTC в календаре будет наступать новый день и текущая дата будет автоматически обновляться.',
        ...
        'weeks'             => 'Дайте названия наиболее важным неделям в вашего календаря.',
    ...
    'placeholders'  => [
        ...
        'recurring_until'   => 'Последний год повторения (если здесь пусто, событие будет повторяться вечно)',
        'seasons'           => 'Число времен года',
        'suffix'            => 'Краткое обозначение текущей эры (Например: НЭ, до НЭ)',
        'type'              => 'Тип календаря',
