...
return [
    ...
    'pins'              => [
        'description'   => 'Связи и атрибуты объектов можно закреплять в правой части страницы истории объекта. Чтобы закрепить элемент, выберите "Закрепить" при редактировании связи или нажмите на звездочку возле нужного атрибута.',
