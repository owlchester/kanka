...
return [
    ...
    'hints'         => [
        ...
        'personality_not_visible'   => 'В данный момент черты характера этого персонажа видят только Администраторы.',
        'personality_visible'       => 'Черты характера этого персонажа видят все пользователи.',
    ],
    'index'         => [
        'actions'       => [
