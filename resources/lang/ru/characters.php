...
return [
    ...
    'hints'         => [
        'is_dead'                   => 'Мертв ли этот персонаж?',
        'is_personality_visible'    => 'Вы можете скрыть весь раздел "Личные качества" от всех пользователей, кроме админов.',
    ...
    'items'         => [
        ...
        'hint'          => 'Предметы можно связать с персонажами, чтобы отображать их здесь.',
    ...
    'organisations' => [
        ...
        'hint'          => 'Персонажи могут быть частью нескольких организаций, которые показывают, на кого они работают или в какое тайное общество входят.',
        'placeholders'  => [
    ...
    'placeholders'  => [
        ...
        'personality_name'  => 'Тип. Цель, поведение, страх, принцип и т.д.',
        'physical'          => 'Физиология',
        'race'              => 'Раса',
        'sex'               => 'Пол (гендер)',
        'title'             => 'Титул',
