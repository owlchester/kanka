...
return [
    ...
    */
    ...
    'failed'    => 'Не верные входные данные.',
    'helpers'   => [
    ...
    'register'  => [
        ...
        'email'                     => [
            'body'  => '<p>Добро пожаловать в kanka.io!</p><p>Ваш аккаунт создан с помощью адреса электронной почты.</p>',
            'login' => 'Войти',
            'title' => 'Начало работы с Kanka',
        ],
        'errors'                    => [
            'email_already_taken'   => 'Аккаунт с такой электронной почтой уже зарегистрирован.',
            'general_error'         => 'Во время регистрации произошла ошибка. Пожалуйста, попробуйте еще раз.',
        ],
        'fields'                    => [
            'email'     => 'Электронная почта',
        ...
        'welcome_email'             => [
            ...
            'section_10'    => 'Патреонцев',
            'section_11'    => 'Создай свой мир,',
            'section_2'     => 'Самый важный ресурс это :discord, где вы найдете множество наших преданных пользователей, команду помощи новоприбывшим, а также основатель Kanka, который может ответить на любые ваши вопросы.',
            'section_3'     => 'Наше :faq также охватывает самые распространенные вопросы.',
            ...
            'section_7'     => 'Если вы не нашли ответ на свои вопросы или просто хотите с нами связаться, можете найти нас на :facebook или отправить письмо на :email. Мы маленькая команда из 2 друзей, но мы точно ответим на каждое полученное письмо, так что, пожалуйста, не стесняйтесь!',
            'section_8'     => 'Напоследок',
            'section_9'     => 'Мы сделали все основные функции Kanka бесплатными, и всегда будем следовать этому пути. Однако, если вы хотите поддержать нас в этом проекте, вы можете вступить в ряды наших :patrons и получить доступ к дополнительным функциям, а также нашу вечную благодарность!',
            'title'         => 'Начало работы с Kanka',
        ],
    ],
    'reset'     => [
