    ...
    */
    ...
    'register'  => [
        ...
        'welcome_email'             => [
            ...
            'section_2'     => 'Самый важный ресурс это :discord, где вы найдете множество наших преданных пользователей, команду помощи новичкам, а также основателя Kanka, который может ответить на любые ваши вопросы.',
