    ...
    */
    ...
    'register'  => [
        ...
        'welcome_email'             => [
            ...
            'section_2'     => 'Самый важный ресурс это :discord, где вы найдете множество наших преданных пользователей, команду помощи новоприбывшим, а также основателя Kanka, который может ответить на любые ваши вопросы.',
            'section_3'     => 'Наши :faq также охватывают самые распространенные вопросы.',
            ...
            'section_9'     => 'Мы сделали все основные функции Kanka бесплатными, и всегда будем следовать этому пути. Однако, если вы хотите поддержать нас в этом проекте, вы можете вступить в ряды наших :patrons и получить доступ к дополнительным функциям, а также нашу бесконечную благодарность!',
            'title'         => 'Начало работы с Kanka',
        ],
    ],
    'reset'     => [
