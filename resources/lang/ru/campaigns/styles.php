...
return [
    ...
    'helpers'   => [
        'css_moved' => 'Поле для CSS перемещено в новый гибкий интерфейс, внесенный в меню управления кампанией как :link.',
        'here'      => 'в нашем блоге',
        'main'      => 'Вы можете создавать собственные CSS стили для ваших усиленных кампаний. Эти стили применяются после всех тем из Каталога, примененных к кампании. Больше о стилях кампаний можно узнать :here.',
    ],
    'pitch'     => 'Составьте собственный код на CSS, для полного контроля над видом и атмосферой кампании.',
    'reorder'   => [
