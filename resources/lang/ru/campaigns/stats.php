...
return [
    ...
    'helper'        => 'Улучшайте свои результаты и получайте разнообразные достижения для вашей кампании. Эти цифры обновляются каждые 24 часа.',
    ...
    'title'         => 'Достижения кампании :campaign',
    'titles'        => [
