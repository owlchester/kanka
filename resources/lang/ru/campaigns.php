...
,
    ...
    'members'                           => [
        ...
        'invite'                => [
            'description'   => 'Вы можете приглашать друзей в вашу кампанию, отправив им пригласительную ссылку. После принятия приглашения, они будут добавлены в кампанию как участники указанной роли. Вы также можете отправить приглашение по электронной почте.',
    ...
    'roles'                             => [
        ...
        'helper'        => [
            ...
            '2' => 'Можно задать разрешения для отдельных объектов, открыв вкладку "Разрешения" при редактировании объекта. Эта вкладка отображается, если в кампании есть несколько ролей или участников.',
