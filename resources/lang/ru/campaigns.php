...
,
    ...
    'export'                            => [
        ...
        'helper_third'      => 'Файлы формата JSON можно открывать с помощью любого приложения для работы с текстом. Они отображают информацию, хранящуюся в базе данных Kanka, в виде текста. Экспорт невозможно импортировать обратно в Kanka.',
