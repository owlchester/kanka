...
,
    ...
    'export'                            => [
        ...
        'helper_secondary'  => 'Вы получите два файла - один с экспортировщиком объектов в формате JSON, а другой с изображениями, загруженными на объекты. Учтите, что на достаточно больших кампаниях экспорт изображений повреждается и может быть восстановлен только с помощью :api.',
