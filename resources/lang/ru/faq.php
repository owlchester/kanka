...
,
    ...
    'conversations'         => [
        'answer'    => 'Разговоры это записи разговоров между персонажами или участниками кампании. Например, если вы хотите задокументировать важный разговор между NPC и персонажами игроков, можете использовать этот модуль. Их также можно использовать для ведения кампаний по чату или почте.',
    ...
    'discord'               => [
        'answer'    => 'Чтобы связать ваш аккаунт Kanka с :discord, для начала нажмите на ваш аватар в правом верхнем углу приложения и нажмите на кнопку "Профиль". Оттуда перейдите в :apps и нажмите "Подключить".',
...
,
    ...
    'mobile'                => [
        'answer'    => 'На данный момент у Kanka нет мобильной версии, но большая ее часть работает на мобильных устройствах. Мы надеемся, что поддержка через подписки однажды позволит нам нанять кого-нибудь для разработки мобильного приложения, но не стоит ждать этого в ближайшем будущем.',
    ...
    'organise_play'         => [
        'answer'    => 'Мы являемся партнерами :lfgm, позволяющим вам организовывать сессии с вашей группой. Вы можете синхронизировать вашу кампанию Kanka с вашей кампанией LFGM, чтобы показывать, когда вы свободны, прямо в обзоре кампании.',
...
Мы и сами используем Kanka, так что мы не планируем останавливать ее разработку и развитие. Однако, на всякий случай, код приложения находится в открытом доступе, и проект может быть продолжен сообществом, если с нами что-нибудь случится.
TEXT
,
