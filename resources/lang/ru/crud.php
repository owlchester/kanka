...
return [
    ...
    'move'                      => [
        ...
        'hints'         => [
            'campaign'  => 'Также можете попробовать переместить этот объект в другую кампанию.',
            'copy'      => 'Выберите это, если хотите создать копию объекта в новой кампании.',
            'target'    => 'Пожалуйста, учтите, что некоторые данные могут быть потеряны при переходе элемента из одного типа в другой.',
        ],
        'panels'        => [
            'change'    => 'Изменение типа объекта',
            'move'      => 'Перемещение в другую кампанию',
        ],
