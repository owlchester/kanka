...
return [
    ...
    'entity_personality_visibilities'   => [
        'private'   => 'Les nouvelles personnes ont leur personnalité privée par défault.',
    ],
    'entity_visibilities'               => [
    ...
    'fields'                            => [
        ...
        'entity_personality_visibility' => 'Visibilité des traits de personne',
    ...
    'roles'                             => [
        ...
        'helper'        => [
            '1' => 'Une campagne peut avoir autant de rôle que désiré. Le rôle "Admin" a automatiquement accès à tout dans une campagne, et chaque autre rôle peut être configuré pour avoir des accès spécifiques à divers entités (personnes, lieux, etc).',
    ...
    'settings'                          => [
        ...
        'helpers'       => [
            ...
            'conversations' => 'Conversations fictives entre des personnes ou entre membres de la campagne.',
            ...
            'journals'      => 'Observations écritent par des personnes, ou préparation de session pour le maître de jeu.',
            ...
            'quests'        => 'Gestionnaire de quêtes avec personnes et lieux.',
