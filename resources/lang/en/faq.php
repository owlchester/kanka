...
Supporting us on Patreon however allows you to increase file size upload limits, adds your name to the Patreon wall of fame, have nicer default icons, vote on prioritising what gets works on and more!'
    ...
    'attribute-templates' => [
        ...
        'answer' => 'The best way we can explain Attribute Templates is with an example. Let\'s imagine that your world has lots of Locations, and on many of those locations, you want to remember to create a custom Attribute for "Population", "Climate", "Crime Level". 
