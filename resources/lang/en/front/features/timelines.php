...
return [
    ...
    'third' => 'Eras are then composed of elements. These can be quick scribbles, or linked to entities. A user of the campaign will only see elements linked to entities they can view. This means you can include potential spoilers and be still sure your players won\'t find out when viewing a timeline.',
