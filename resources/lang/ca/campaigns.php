...
,
    ...
    'options'                           => [
        'entity_personality_visibility' => 'Fes que la personalitat dels nous personatges sigui privada per defecte.',
        'entity_visibility'             => 'Fes que les entitats noves siguin privades per defecte.',
    ],
    'panels'                            => [
        'boosted'   => 'Millores',
        'dashboard' => 'Taulell',
