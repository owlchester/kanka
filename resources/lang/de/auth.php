...
return [
    ...
    'login'     => [
        ...
        'login_with_twitter'    => 'Login mit Twitter',
    ...
    'register'  => [
        ...
        'email'                     => [
            'body'  => '<p>Willkommen bei kanka.io!</p><p>Dein Account wurde mit deiner Email Adresse erstellt.</p>',
            'login' => 'Login',
            'title' => 'Willkommen bei kanka.io!',
        ],
        'errors'                    => [
        ...
        'register_with_twitter'     => 'Mit Twitter registrieren',
        'submit'                    => 'Registrieren',
        'title'                     => 'Registrieren',
    ],
    'reset'     => [
