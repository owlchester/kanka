<template>
    <div class="mx-5">
        <span role="button" class="sidebar-toggle text-center cursor-pointer fill-current hover:text-primary-focus" data-toggle="tooltip" :data-title="title" data-placement="right" data-html="true" tabindex="3">
