<template>
    <div class="flex flex-col gap-2">
        <label
            class="text-xs font-semibold uppercase tracking-wide text-neutral-content"
            >{{ i18n.group }}</label
        >
        ...
        <div class="flex flex-wrap gap-1">
            <button
                type="button"
                class="flex items-center gap-1.5 rounded-lg px-2.5 py-1 cursor-pointer border-2"
                :class="
                    pin.groupId === null
            ...
            >
                <span
                    class="inline-block w-2.5 h-2.5 rounded-full bg-neutral-content flex-none"
                    aria-hidden="true"
                />
                <span>{{ i18n.none }}</span>
            </button>
            ...
            >
                <span
                    ...
                    :style="
                        group.colour ? { backgroundColor: group.colour } : {}
                    "
                    aria-hidden="true"
                />
