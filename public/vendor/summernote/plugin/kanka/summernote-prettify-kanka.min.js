...
/***/ "./src/Module/SummernotePrettify.ts":
/*!******************************************!*\
  !*** ./src/Module/SummernotePrettify.ts ***!
  \******************************************/
...
var htmlParser = __webpack_require__(/*! prettier/parser-html */ "./node_modules/prettier/parser-html.js");
var SummernotePrettify = /** @class */ (function () {
    function SummernotePrettify(options) {
        this.options = $.extend({
            name: 'prettify',
    ...
    SummernotePrettify.prototype.createButton = function () {
        var _this = this;
    ...
    SummernotePrettify.prototype.prettierFormat = function (html) {
        return prettier.format(html, {
            parser: "html",
            plugins: { htmlParser: htmlParser }
        });
    };
    SummernotePrettify.prototype.prettify = function () {
        try {
            // Turn on code view
            if (!this.editor.hasClass('codeview')) {
                this.context.invoke('codeview.toggle');
            }
            var html = this.editable.html();
            //console.log('html', html);
            var pretty = this.prettierFormat(html);
    ...
    SummernotePrettify.prototype.initPrettify = function (context) {
    ...
    return SummernotePrettify;
}());
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (SummernotePrettify);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _SummernotePrettify__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./SummernotePrettify */ "./src/Module/SummernotePrettify.ts");

var PrettifyPlugin = /** @class */ (function () {
    function PrettifyPlugin(options) {
        this.summernote_prettify = new _SummernotePrettify__WEBPACK_IMPORTED_MODULE_0__["default"](options);
    }
    PrettifyPlugin.prototype.getPlugin = function () {
        var plugin = {};
        var _this = this;
        var options = this.summernote_prettify.options;
        // @ts-ignore
        plugin[options.name] = function (context) {
            var sgOptions = context.options[options.name] || {};
            var buttonLabel = sgOptions.buttonLabel || _this.summernote_prettify.options.buttonLabel;
    ...
    PrettifyPlugin.prototype.createButton = function () {
        return this.summernote_prettify.createButton();
    };
    return PrettifyPlugin;
}());
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (PrettifyPlugin);
...
var prettify_plugin = new _Module__WEBPACK_IMPORTED_MODULE_0__["default"]({});
// add the plugin to summernote
$.extend($.summernote.plugins, prettify_plugin.getPlugin());
