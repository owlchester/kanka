    ...
    tinymce.create('tinymce.plugins.Mention', {
        ...
        init: function (ed) {
            ...
            function prevCharIsSpace() {
                ...
                // We always want this to be true.
            ...
            if (isMobile) {
                ...
                ed.on('keypress', function (e) {
                    console.log('fire (key, code, char)', e.key, e.code, e.char);
                    var delimiterIndex = $.inArray(String.fromCharCode(e.which || e.keyCode || e.key), autoCompleteData.delimiter);
                    if (delimiterIndex > -1 && prevCharIsSpace()) {
                        if (autoComplete === undefined || (autoComplete.hasFocus !== undefined && !autoComplete.hasFocus)) {
                            e.preventDefault();
                            // Clone options object and set the used delimiter.
                            autoComplete = new AutoComplete(ed, $.extend({}, autoCompleteData, {delimiter: autoCompleteData.delimiter[delimiterIndex], mobile: mobile}));
                        }
                    }
                });
            }
