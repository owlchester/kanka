...
;(function (f) {
    ...
    AutoComplete.prototype = {
        ...
        // Reposition the dropdown menu if it's out of bounds
        reposition: function() {
            var offset = this.editor.inline ? this.offsetInline() : this.offset();
            var offsetedDocumentWidth = $(document).width(); // arbitrary value
            //console.log('yo', this.$dropdown.width(), offset.left + 20, offsetedDocumentWidth);
            if (this.$dropdown.width() + offset.left + 20 >  offsetedDocumentWidth) {
