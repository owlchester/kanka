...
Route::get('/w/{campaign}/recovery-posts', 'Campaign\RecoveryController@posts')->name('recovery.posts');
Route::post('/w/{campaign}/recovery-posts', 'Campaign\RecoveryController@recoverPosts')->name('recovery.save.posts');
