...
class CharacterObserver extends MiscObserver
{
    ...
    {
        // Default checkboxes that can be set to null.
        if (request()->has('is_personality_visible')) {
            $model->setAttribute('is_personality_visible', request()->post('is_personality_visible'));
        }
