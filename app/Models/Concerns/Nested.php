 ...
 *
 * We simply copy-pasted the Kalnoy trait, but removed the static deleted method because it doesn't work for Kanka
...
trait Nested
{
    ...
    public static function bootNested()
    {
        ...
        static::deleted(function ($model) {
            // We don't want this feature of the nested plugin, so we just ignore it :)
