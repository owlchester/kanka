...
class UpdateCalendarEvent extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'recurring_until' => 'required_with:recurring_until_month|required_with:recurring_until_day|nullable|integer',
            'recurring_until_month' => 'required_with:recurring_until_day|nullable|integer',
            'recurring_until_day' => 'nullable|integer',
