...
class AddCalendarEvent extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'recurring_until' => 'required_with:recurring_until_month|required_with:recurring_until_day|nullable',
            'recurring_until_month' => 'required_with:recurring_until_day|nullable',
            'recurring_until_day' => 'nullable',
