...
class StoreCalendar extends FormRequest
{
    ...
    public function rules()
    {
        $rules = [
            ...
            'era_start_year.*' => 'nullable|integer|min:0',
            'era_start_month' => 'nullable|array',
            'era_start_month.*' => 'nullable|integer|min:1',
            'era_start_day' => 'nullable|array',
            'era_start_day.*' => 'nullable|integer|min:1',
            'era_end_year' => 'nullable|array',
            'era_end_year.*' => 'nullable|integer|min:0',
            'era_end_month' => 'nullable|array',
            'era_end_month.*' => 'nullable|integer|min:1',
            'era_end_day' => 'nullable|array',
            'era_end_day.*' => 'nullable|integer|min:1',
