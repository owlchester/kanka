...
class FrontController extends Controller
{
    ...
    {
        $features = Campaign::public()->featured()->orderBy('visible_entity_count', 'desc')->get();
        $campaigns = Campaign::public()->featured(false)->orderBy('visible_entity_count', 'desc')->paginate();
