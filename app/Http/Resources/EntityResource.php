...
class EntityResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        $data = [
            ...
            'is_attributes_private' => $entity->is_attributes_private,
    ...
    public function entity(array $prepared = [])
    {
        ...
        $merged = [
            ...
            'is_private' => $misc->entity->is_private,
            'is_template' => $misc->entity->isTemplate(),

            'is_attributes_private' => $misc->entity->is_attributes_private,
