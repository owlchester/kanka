...
it('returns the full explore payload for a simple map', function () {
    ...
    $response = $this->get(route('entities.map-api', [1, $map->entity]))
        ...
        ->assertJsonStructure([
            ...
            'i18n' => ['legend_title', 'legend_search', 'ungrouped', 'loading', 'error_load', 'error_delete', 'from_entry', 'linked_entity', 'edit_details', 'center', 'duplicate', 'delete_marker', 'delete_confirm', 'markers_count_one', 'markers_count_other'],
        ]);
